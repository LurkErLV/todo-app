    ...
    return (
        <>
            <div
                ...
                <p className={`px-4 break-words max-w-[632px] w-full min-w-[180px] ${props.isCompleted ? "line-through decoration-gray-300 text-gray-300" : "text-gray-100"}`}>{props.children}</p>

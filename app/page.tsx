        ...
        <>
            <header className="bg-gray-700 h-[200px] w-full flex justify-center items-center">
                <div className="relative w-full h-full max-w-[126px] max-h-[46px]">
                    <Image src="./todo.svg" fill={true} alt="Logo"/>
                </div>
            </header>
            <main className="w-full max-w-[736px] mx-auto mt-[-27px]">
                ...
                <div className="w-full mt-16">
                    ...
                    {tasks === 0 &&
                        <>
                            ...
                            <div className="flex flex-col items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" href="http://www.w3.org/1999/xlink" width="56"
                                ...
                                <p className="text-gray-300 text-center text-base font-bold mt-4">You don't have tasks
                                    registered yet</p>
                                <p className="text-gray-300 text-center text-base font-normal">Create tasks and organize
                                    your to-do items</p>
                            </div>
                        </>
                    }
                    {
                        tasks > 0 &&
                        <>
                            <Task key={1} isCompleted={false}>Integer urna interdum massa libero auctor neque turpis
                                turpis semper. Duis vel sed fames integer.</Task>
                        </>
                    }
